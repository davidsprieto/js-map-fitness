...
class App {
  ...
  _renderWorkout(workout) {
    ...
    // Have to wait until a new workout is created and rendered on the page before querying the DOM and attaching an event handler to the edit & delete workout buttons
